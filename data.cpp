...
extern bus_route* get_serializable_object() {
    bus_stop * bs1 = new bus_stop_detail("Taichung Airport", gps(24.253475), gps(120.598994));
    bus_stop * bs2 = new bus_stop_detail("Xinwuri Station", gps(24.1086998), gps(120.6144028));
